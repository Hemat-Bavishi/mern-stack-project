  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Become A Farm Factory Seller!</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Would you like to sell your products on Farm Factory!</h3>
                  <h5>Grow your business with Farm Factory</h5>
                  <b>Apply Today</b>
                </div>
              </Col>
